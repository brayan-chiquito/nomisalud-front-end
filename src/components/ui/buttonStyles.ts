...
const variants: Record<ButtonVariant, string> = {
  primary:
    'bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg focus:ring-2 focus:ring-primary-600/30 focus:ring-offset-1 active:scale-[0.98]',
  secondary: 'bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 px-4 py-2 rounded-lg',
  danger: 'bg-danger hover:brightness-95 text-white px-4 py-2 rounded-lg',
